...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF888888);
  ...
  late Color accent2 = const Color(0xFF00FF00);
  late Color accent3 = const Color(0xFF0000FF);
  late Color accent4 = const Color(0xFFFFFF00);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0xFFFF5555);
  late Color accent2 = const Color(0xFF55FF55);
  late Color accent3 = const Color(0xFF5555FF);
  late Color accent4 = const Color(0xFFFFFF55);
  late Color success = const Color(0xFF55FF55);
  late Color warning = const Color(0xFFFFFF55);
  late Color error = const Color(0xFFFF5555);
  late Color info = const Color(0xFF5555FF);
}
