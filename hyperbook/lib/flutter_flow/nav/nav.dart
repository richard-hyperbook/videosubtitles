          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => ChapterEditWidget(
                chapter: params.getParam('chapter', ParamType.DocumentReference,
                    false, ['hyperbooks', 'chapters']),
                title: params.getParam('title', ParamType.String),
                body: params.getParam('body', ParamType.String),
                hyperbook: params.getParam('hyperbook',
                    ParamType.DocumentReference, false, ['hyperbooks']),
            ...
            FFRoute(
              ...
              builder: (context, params) => NavBarPage(
                initialPage: '',
                page: MapDisplayWidget(
                  hyperbook: params.getParam('hyperbook',
                      ParamType.DocumentReference, false, ['hyperbooks']),
                  hyperbookTitle:
                      params.getParam('hyperbookTitle', ParamType.String),
                  moderator: params.getParam('moderator',
            ...
            FFRoute(
              ...
              builder: (context, params) => HyperbookEditWidget(
                ...
                hyperbookTitle:
                    params.getParam('hyperbookTitle', ParamType.String),
                hyperbookBlurb:
                    params.getParam('hyperbookBlurb', ParamType.String),
                hyperbookType: params.getParam('hyperbookType', ParamType.int),
                requresReaderApproval:
                    params.getParam('requresReaderApproval', ParamType.String),
                requiresWriterApproval:
                    params.getParam('requiresWriterApproval', ParamType.String),
                visibility: params.getParam('visibility', ParamType.String),
                startChapter: params.getParam(
                    'startChapter',
                    ParamType.DocumentReference,
                    false,
                    ['hyperbooks', 'chapters']),
                collaboratorPriviledges: params.getParam(
                    'collaboratorPriviledges', ParamType.String),
                moderator: params.getParam(
                    'moderator', ParamType.DocumentReference, false, ['users']),
              ),
            ),
            FFRoute(
              name: 'tutorial',
            ...
            FFRoute(
              ...
              builder: (context, params) => ChapterReadWidget(
                ...
                hyperbook: params.getParam('hyperbook',
                    ParamType.DocumentReference, false, ['hyperbooks']),
                chapterState: params.getParam('chapterState', ParamType.int),
                chosenColors: params.getParam<Color>(
                    'chosenColors', ParamType.Color, true),
                chapterReaderIndex:
                    params.getParam('chapterReaderIndex', ParamType.int),
                readReference: params.getParam(
                    'readReference',
                    ParamType.DocumentReference,
                    false,
                    ['users', 'readReferences']),
              ),
            ),
            FFRoute(
